        ...
        def index_comple():
          for j in range(2):
            ...
            st.markdown(
                ...
                unsafe_allow_html=True)
            st.markdown("***")
            # st.markdown(f'<span style="font-size:20px ;"> _Count number of completeness columns :_ {count}</span>',unsafe_allow_html=True)
            # st.write ("Total number of columns : ", total_column)
